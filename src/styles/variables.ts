...
export const device = {
	mobileS:		`(min-width: ${DeviceWidth.mobileS.value})`,
	mobileM:		`(min-width: ${DeviceWidth.mobileM.value})`,
	mobileL:		`(min-width: ${DeviceWidth.mobileL.value})`,
	tablet:		 	`(min-width: ${DeviceWidth.tablet.value})`,
	laptop:		 	`(min-width: ${DeviceWidth.laptop.value})`,
	laptopL:		`(min-width: ${DeviceWidth.laptopL.value})`,
	desktop:		`(min-width: ${DeviceWidth.desktop.value})`,
	desktopL:		`(min-width: ${DeviceWidth.desktop.value})`
};
